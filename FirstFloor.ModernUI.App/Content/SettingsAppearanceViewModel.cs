...
namespace FirstFloor.ModernUI.App.Content
{
        ...
        : NotifyPropertyChanged
    {
        ...
        private const string PaletteWP = "Otros";
        ...
        public SettingsAppearanceViewModel()
        {
           ...
           // this.themes.Add(new Link { DisplayName = "hello kitty", Source = new Uri("/ModernUIDemo;component/Assets/ModernUI.HelloKitty.xaml", UriKind.Relative) });
            this.themes.Add(new Link { DisplayName = "Magnolia", Source = new Uri("/ModernUIDemo;component/Assets/ModernUI.Love.xaml", UriKind.Relative) });
